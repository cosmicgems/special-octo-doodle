    ...
    <footer className='grow-0' style={{fontFamily:'kodchasan'}} >
        ...
        <div className='flex flex-row justify-center items-center'>
          <div className='px-12 text-center m-0'>
            <Typography variant='overline' className='' sx={{fontFamily: 'rajdhani'}}>&copy; COPYRIGHT 2023 Developed and designed w/&#10084;&#65039; by<span style={{fontFamily:'kodchasan'}}> Maliek Davis</span> </Typography>               
          </div>
        </div>
